...
#    Updated: 2025/03/10 12:56:12 by yosherau         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		=		add_to_stack.c check_input.c cost_analysis_a.c current_index.c find_largest_node.c ft_atol.c ft_isdigit.c ft_lstlast.c ft_split.c ft_strchr.c \
					...
					push_swap.c pa.c pb.c ra.c rb.c repeat.c rr.c sa.c sb.c set_cheapest.c set_target_a.c ss.c stack_free.c stack_init.c stack_sort.c write_error.c
